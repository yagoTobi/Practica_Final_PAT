...
public class HostController {
    ...
    /*Debemos de implementar el getter del host individual 
    @GetMapping("/hostMembers/{userId}")
    public ResponseEntity<Iterable<HostModel>> getHostById(@PathVariable ("userId") Long userId)
    {
        return hostService.getHostById(userId);
    }*/
}